...
def decode_token(token: str) -> Dict[str, Any]:
    ...
    try:
        ...
        # Fallback for Supabase tokens (bypass signature check if secret is missing)
        # WARNING: This trusts the token content without verification. 
        # Only acceptable because we trust the source (Supabase) via SSL transport 
        # and this is a specific user request to make mixed-mode work.
        try:
...
def verify_token(token: str, token_type: str = "access") -> Dict[str, Any]:
    ...
    # Support Supabase tokens (which have aud="authenticated")
