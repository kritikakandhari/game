...
export default function RegisterPage() {
  ...
  const { refreshUser, signInWithOAuth } = useAuth(); // Destructure signInWithOAuth
    ...
    try {
      ...
      if (axiosError.response?.data?.error) {
        ...
        if (errorData.details && Array.isArray(errorData.details) && errorData.details.length > 0) {
          ...
          errorMessage = `${field.charAt(0).toUpperCase() + field.slice(1)}: ${firstError.msg}`;
        } else {
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-2xl bg-white/5 backdrop-blur-sm border border-white/10 p-4 md:p-8 shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              {/* Added OAuth Section correctly placed */}
